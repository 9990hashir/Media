...
if (Config.LANG == 'ML') ldc = '*ലിങ്ക് കണ്ടെത്ത�?!*'
if (Config.LANG == 'ID') ldc = '*Tautan Terdeteksi!*'
if (Config.LANG == 'PT') ldc = '*Link Detectado!*'
if (Config.LANG == 'RU') ldc = '*Ссылка обнаружена!*'
if (Config.LANG == 'HI') ldc = '*लिंक का पत�? चल�?!*'
...
var plk9 = ''
 ...
 if (Config.LANG == 'ML') {
         plk1 = '```എല്ല�? കമാൻഡുകളും ലഭിക്കാൻ .help ടൈപ്പ് ചെയ്യുക```'
         plk2 = 'എന്റ�? പേര് '
         plk3 = 'അത�? എന്നോട�? പറയൂ, ഞാ�? നിങ്ങള�? എങ്ങനെ സഹായിക്കും'
         plk4 = '👻Boo-o-o-oh👻'
         plk5 = 'എനിക്കറിയാ�? അവ�? എന്റ�? സ്രഷ്ടാവാണെന്ന�?'
         plk6 = 'ᴍᴏꜱꜱ , ꜱᴀʜᴀʟ , ᴄʜᴇʀʀʏ , ꜰᴀʀʜᴀɴ'
         plk7 = 'ഞാ�? .... ആഹ�? ഞാ�? ആരാണെന്ന�? എനിക്കറിയില്�? \n ഞാ�? ആരാണെന്ന�? നിങ്ങൾക്കറിയാമെങ്കിൽ ദയവായി എന്നോട�? പറയു🥺🥺'
         plk8 = 'ആരെങ്കിലും എന്ന�? സഹായിക്ക�?, �? വ്യക്ത�? മോശമായ�? സംസാരിക്കുന്നു \n ഞാ�? ഒര�? നല്ല പെൺകുട്ടിയാണ�? ... \n\n ട്രി�?..ട്രി�? ... *ഹല�? പോലീസ് സ്റ്റേഷൻ *'
         ...
         plk14 = 'ശുഭരാത്ര�?'
         plk15 = 'സുഖനിദ്ര'
         plk16 = 'ദിവസ�? എത്ര മോശമായിരുന്നിട്ടും, എല്ലായ്പ്പോഴും അത�? നല്ല ചിന്തകളോടെ അവസാനിപ്പിക്കാ�? ശ്രമിക്കുക. അടുത്ത ദിവസ�? ശ്രദ്ധ കേന്ദ്രീകരിക്കാൻ ശ്രമിക്കുക, ഒപ്പ�? ഒര�? മധുര സ്വപ്നത്തിനായി പ്രതീക്ഷിക്കു�?. ശു�? രാത്രിറ്'
         plk17 = 'രാത്രികൾ വിശ്രമിക്കുന്നതിനാണ്, വിഷമിക്കേണ്ടതില്�?. അതിനാൽ, കിടക്കയി�? കയറി കുറച്ച�? ഉറങ്ങു�?. ശു�? രാത്രി! പുതി�? സാധ്യതകൾ നിറഞ്ഞ ഒര�? പുതി�? ദിവസ�? നിങ്ങള�? കാത്തിരിക്കുന്നു'
         plk18 = 'Welcome'
      }//afnanplk creation
    else {
        plk1 = 'type .list'
...
Asena.addCommand({on: 'text', fromMe: false, deleteCommand: false}, (async (message, match) => {
  ...
  await message.client.sendMessage(message.jid,Jimbrootan.OA_REPLY, MessageType.text, {quoted: message.data })
           ...
           await message.client.sendMessage(message.jid,plk18, MessageType.text, {quoted: message.data })
        }
   }
}));
